...
export function PortfolioCharts({ positions, history }: Props) {
    ...
    <div className={styles.section}>
      ...
      <div className={styles.chartsGrid}>
        <div className={styles.chartCard}>
          <h3 className={styles.chartTitle}>Tenencia actual (mayor a menor)</h3>
        ...
        <div className={styles.chartCard}>
          <h3 className={styles.chartTitle}>P&L no realizado por activo</h3>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <div className={styles.chartCard}>
          <h3 className={styles.chartTitle}>Rendimiento en ventas (P&L realizado)</h3>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={positions}>
              <CartesianGrid strokeDasharray="3 3" />
              <XAxis dataKey="ticker" />
        ...
        <div className={styles.chartCard}>
          <h3 className={styles.chartTitle}>Evolución del portafolio</h3>
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={historyData}>
              ...
              <Area type="monotone" dataKey="cumulativeRealizedPnl" name="P&L realizado acumulado" stroke="#22c55e" fill="#22c55e" fillOpacity={0.3} />
            </AreaChart>
          </ResponsiveContainer>
        </div>
      </div>
